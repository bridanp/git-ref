...
<html>
  <head>
    ...
    <title>Git-ref by bridanp</title>
  </head>
  ...
  <body>
    ...
    <header>
      <div class="containerh">
        <h1>Git Reference Basics</h1>
        <h2>Try <a rel="nofollow" href="http://www.amazon.com/gp/product/1484200772/ref=as_li_tl?ie=UTF8&camp=1789&creative=9325&creativeASIN=1484200772&linkCode=as2&tag=findcheap-20&linkId=ZMHZQIXBJRFX74WZ">Pro Git</a><img src="http://ir-na.amazon-adsystem.com/e/ir?t=findcheap-20&l=as2&o=1&a=1484200772" width="1" height="1" border="0" alt="" style="border:none !important; margin:0px !important;" /> for more expert and detailed commands.</h2>
      </div>
    </header>
    <div class="container">
...
<script type="text/javascript">
  ...
  amzn_assoc_tracking_id = "findcheap-20";
  amzn_assoc_linkid = "XXZCSRH3KMO57DYE";
